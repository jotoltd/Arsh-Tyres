...
export interface Booking {
  ...
  fittingFee: number;
  totalPrice: number;
  fittingType: 'fitting' | 'mobile' | 'delivery' | 'collection'; // 'fitting' (fitted at our premises), 'mobile' (fitted at home/work), 'delivery' (tyres only delivery), 'collection' (pick up, no fitting)
